...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer: Schema.Attribute.Relation<'oneToOne', 'api::menu.menu'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    menu: Schema.Attribute.Relation<'oneToOne', 'api::course.course'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    featuredCourse: Schema.Attribute.Component<'layout.feature-course', false>;
...
export interface ApiSeoconfigSeoconfig extends Struct.SingleTypeSchema {
  collectionName: 'seoconfigs';
  info: {
    displayName: 'Seoconfig';
    pluralName: 'seoconfigs';
    singularName: 'seoconfig';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiStaticPageStaticPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pageInfo: Schema.Attribute.Component<'layout.page-info', true>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::seoconfig.seoconfig': ApiSeoconfigSeoconfig;
